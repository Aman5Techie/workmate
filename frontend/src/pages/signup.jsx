...
const Signup = () => {
  ...
  const submitform = async (e) => {
    ...
    for (const key in userdata) {
      if (userdata[key] === undefined || userdata[key].trim() === "") {
  ...
  return (
    <>
      {role == null ? (
        ...
        <div className="h-full items-center flex justify-center px-5 lg:px-0 py-10">
            ...
            <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
              <div className=" flex flex-col items-center">
                <div className="text-center">
                  ...
                  <p className="text-[12px] py-2 text-gray-500">
